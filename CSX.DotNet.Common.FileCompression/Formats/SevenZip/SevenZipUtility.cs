...
namespace CSX.DotNet.Common.FileCompression.Formats.SevenZip;

public sealed class SevenZipUtility : ArchiveUtilityBase
{
        ...
        CancellationToken ctoken = default)
    {
        ...
        await using var reader = await ArchiveFactory
            .OpenAsyncArchive(archivePath, cancellationToken: ctoken);

        await foreach (var entry in reader.EntriesAsync)
        {
            ...
            await entry.WriteToFileAsync(finalExtractionPath, new ExtractionOptions
            {
